...
class HeadElements {
    ...
    public static function bootstrap() {
        return self::style('//netdna.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css');
    }

    public static function bootstrapJs() {
        return self::script('//netdna.bootstrapcdn.com/bootstrap/3.3.1/js/bootstrap.min.js');
    }
